let chooseEmojii = function () {
    $('.yasn-post-extra-emojiies').show();
    ...
    $(document).ready(function () {
        ...
        // Append multi-purpose emoji container inside main container.
        $('.yasn-post-extra-emojiies').append('' +
            '<div id="master-moji">' +
            '<input type="hidden" id="master-moji-anchor" value=""/>' +
            '    <div class="dropdown emojii-container-main"> ' +
            '        <div class="emojii-container" data-active="emoticons"> ' +
        ...
        // Add emojies to container above
        $.each(emojiiArray, function (key, data) {
            firstele = data[0];

            $('.emojii-container').find('.nav-tabs').append(
                "<li class='yasn-emojii-tab' data-type='" + key + "'>" +
                "<a href='javascript:void(0);'>&#x" + firstele + ";</a>" +
                "</li>");
        ...
        $('.yasn-post-extra-emojiies').on('click', '.yasn-emojii-tab', function (e) {
            e.preventDefault();
        ...
        // Insert emoji
        $('.yasn-post-extra-emojiies').on('click', '#master-moji .emojii-list li', function (e) {
            e.preventDefault();
            $('#comment-text').append($(this).attr('data-val'));
